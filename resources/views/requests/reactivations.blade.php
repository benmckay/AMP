...
@section('sidebar')
    ...
    <a href="{{ route('requests.reactivations') }}" class="nav-link active">
...
@section('content')
    <h1 class="page-title">Reactivation Requests</h1>
    <div class="card"><div class="card-body">
        ...
        @else
            <p class="text-muted mb-0">No pending reactivation requests.</p>
        @endif
    </div></div>
@endsection
